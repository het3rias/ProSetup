...
// Sube este número cada vez que cambies productosIniciales (imágenes, precios, etc.)
// para que el catálogo guardado en localStorage se actualice solo en el navegador.
...
const productosIniciales = [
    ...
    { id: 4, codigo: "MON-001", nombre: "Monitor Gamer 24\" 144Hz", descripcion: "Monitor Full HD de 24 pulgadas con tasa de refresco de 144Hz.", precio: 149990, stock: 8, stockCritico: 3, categoria: "Monitores", imagen: "img/monitor144.webp" },
    { id: 5, codigo: "ACC-001", nombre: "Mousepad XL RGB", descripcion: "Mousepad extendido con borde iluminado RGB.", precio: 14990, stock: 30, stockCritico: 8, categoria: "Accesorios", imagen: "img/mousepadrgb.jpeg" },
    { id: 6, codigo: "ACC-002", nombre: "Webcam Full HD 1080p", descripcion: "Webcam con resolución 1080p y corrección automática de luz.", precio: 35990, stock: 14, stockCritico: 4, categoria: "Accesorios", imagen: "img/webcam.webp" },
    { id: 7, codigo: "SIL-001", nombre: "Silla Gamer Ergonómica", descripcion: "Silla gamer con respaldo reclinable, apoyabrazos ajustables y base de 5 ruedas.", precio: 119990, stock: 6, stockCritico: 2, categoria: "Sillas y Mobiliario", imagen: "img/silla.webp" },
    { id: 8, codigo: "AUD-002", nombre: "Parlantes Bluetooth 2.1", descripcion: "Set de parlantes 2.1 con subwoofer, conexión Bluetooth y entrada auxiliar.", precio: 42990, stock: 10, stockCritico: 3, categoria: "Audio", imagen: "img/parlantes.webp" },
    ...
    { id: 10, codigo: "ACC-003", nombre: "Hub USB-C 7 en 1", descripcion: "Adaptador USB-C con salida HDMI, lector de tarjetas SD/microSD y 3 puertos USB 3.0.", precio: 24990, stock: 18, stockCritico: 5, categoria: "Accesorios", imagen: "img/conectar71.png" },
    { id: 11, codigo: "ACC-004", nombre: "Soporte de Monitor Articulado", descripcion: "Brazo articulado de escritorio para un monitor, con ajuste de altura e inclinación.", precio: 32990, stock: 11, stockCritico: 3, categoria: "Accesorios", imagen: "img/soporte.png" },
...
function inicializarProductos() {
    ...
    const versionGuardada = Number(localStorage.getItem("productosVersion"));

    // Si no hay nada guardado, o cambió VERSION_CATALOGO (se editaron los
    // productos base en el código), se reemplaza todo el catálogo guardado
    // para que se vean los cambios nuevos (ej: imágenes recién agregadas).
    if (!actuales || versionGuardada !== VERSION_CATALOGO) {
        localStorage.setItem("productosDB", JSON.stringify(productosIniciales));
        localStorage.setItem("productosVersion", String(VERSION_CATALOGO));
        return;
    }
